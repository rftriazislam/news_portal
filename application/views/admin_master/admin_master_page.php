    ...
    <head>
        ...
        <script type="text/javascript">
          function categoryDelete(){
             var message=confirm('Are You Sure To Remove!');
             if(message){
                 return true;
             }else{
                 return false;
        ...
        <div class="navbar">
            <div class="navbar-inner">
                <div class="container-fluid">
                    ...
                    <a class="brand" href="<?php echo base_url() ?>Super_Admin"><span>News Portal Admin</span></a>
                        ...
                        <ul class="nav pull-right">
                            ...
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a href="#"><i class="halflings-icon user"></i> <?php echo $this->session->userdata('admin_name');?></a></li>
                ...
                <div id="sidebar-left" class="span2">
                    <div class="nav-collapse sidebar-nav">
                        <ul class="nav nav-tabs nav-stacked main-menu">
                           ...
                           <li>
                                <a class="dropmenu" ><i class="icon-folder-close-alt"></i><span class="hidden-tablet">News Menu Category</span> <span class="label label-important"> 2</span></a>
                                <ul>
                           ...
                           <li>
                                <a class="dropmenu" ><i class="icon-folder-close-alt"></i><span class="hidden-tablet">News Sub Menu</span> <span class="label label-important"> 2</span></a>
                                <ul>
                                    <li><a class="submenu" href="<?php echo base_url()?>Super_Admin/add_sub_menu"><i class="icon-file-alt"></i><span class="hidden-tablet">Add Sub Menu</span></a></li>
                                    <li><a class="submenu" href="<?php echo base_url()?>Super_Admin/manage_sub_menu"><i class="icon-file-alt"></i><span class="hidden-tablet">Manage Sub Menu</span></a></li>
                ...
                <div class="alert alert-block span10">
                 ...
                 <ul class="breadcrumb">
                        ...
                        <li>
                            ...
                            <a href="<?php echo base_url()?>Super_Admin/<?php echo $sub_breadcrumb_url;?>"><?php echo $sub_breadcrumb_name;?></a></li>
...
<!--/row-->
        ...
        <footer>
            ...
            <p>
                <span  style="text-align:left;float:left ;">&copy; 2019  Copy By <a href="Md Riazul Islam.info" alt="Md Riazul Islam">Riazul Islam</a></span>
