...
<head>
	...
	<!-- end: Favicon -->
			...
			<style type="text/css">
			body { background: url(<?php echo base_url()?>/asset/back_end/img/bg-login.jpg) !important; }
		</style>
			...
			<div class="row-fluid">
				<div class="login-box">
					<div class="icons">
						...
						<a href="#"><i class="halflings-icon cog"></i></a>
                                    ...
                                    <h3 style="color:red;">
                                      ...
                                      echo  $t=$this->session->userdata('message');
					...
					<h2>Login to your account</h2>
                                        <form class="form-horizontal" action="<?php echo base_url()?>Admin/save_admin_information" method="post">
						<fieldset>
							
							<div class="input-prepend" title="Username">
								<span class="add-on"><i class="halflings-icon user"></i></span>
								<input class="input-large span10" name="admin_email" id="username" type="text" placeholder="Username or Email"/>
							</div>
